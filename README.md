...
**Статус:** релиз **0.2.0** — MVP + post-MVP закрыты. Активная дорожная карта — [PLAN.md §11](PLAN.md#11-дорожная-карта--задачи) (волны 0–9, задачи XS–L).
...
| Документ | Содержание |
|----------|------------|
| [PLAN.md](PLAN.md) | Продукт, §5 поведение, **§11 roadmap** (мелкие задачи), синтез аудитов §9 |
