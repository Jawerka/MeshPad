...
bool isHubDisplayName(String name) =>
    name.toLowerCase().contains('hub');
...
List<Device> orderPeersForSync({
  ...
  ordered.sort((a, b) {
    ...
    final aSeen = a.lastSeenAt ?? DateTime.fromMillisecondsSinceEpoch(0, isUtc: true);
    final bSeen = b.lastSeenAt ?? DateTime.fromMillisecondsSinceEpoch(0, isUtc: true);
